                    ...
                    SliverPadding(
                      ...
                      sliver: SliverGrid(
                        gridDelegate:
                          ...
                          crossAxisCount: 3,
                          childAspectRatio: 1.0, // Mengatur rasio 1:1
                          mainAxisSpacing: 15.0, // Jarak vertikal antar item
                          crossAxisSpacing: 15.0, // Jarak horizontal antar item
                        ),
                        delegate: SliverChildBuilderDelegate(
                          (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () {
                                // Implementasi untuk aksi saat gambar di-tap
                              },
                              child: Container(
                                decoration: BoxDecoration(
